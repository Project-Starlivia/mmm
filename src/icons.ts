...
const PATHS = {
  ...
  /** 消しゴムの定番の形。**想像で引かない** — Feather アイコン集の
      `eraser`（community-contributed、24 升目・線幅 2）の座標を、この
      升目（16・線幅 1.4）へ比率どおり縮小しただけ（16/24 倍）。傾いた
      角丸の四角が紙に触れて止まり、中の斜め線が 2 色の継ぎ目を示す —
      形そのものが検証済みなので、ここでは寸法を合わせる以外の判断をしない */
  eraser: "M13.3 13.3H4.7L2 10.7C1.7 10.3 1.7 9.7 2 9.3L8.7 2.7 13.3 7.3 7.3 13.3M4 7.3 8.7 12",
} as const;
