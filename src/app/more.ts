...
export function moreMenu(s: More, a: Acts): MenuEntry[] {
  return [
    ...
    { label: s.grab ? "Exact hit" : "Easy grab", mark: s.grab ? "crosshair" : "square-dashed", run: () => a.toggleGrab() },
    "sep",
